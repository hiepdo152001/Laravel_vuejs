        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                        <router-link :to="{name:'Posts'}" style="text-decoration: none;">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link align-middle px-0">
                           <i class="bi bi-justify"></i><span class="ms-1 d-none d-sm-inline">Category</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link align-middle px-0">
                           <i class="bi bi-tags"></i> <span class="ms-1 d-none d-sm-inline">Tags</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">ListPost</span> 1</a>
                            </li>
                            <li>
